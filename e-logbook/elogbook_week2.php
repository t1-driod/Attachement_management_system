<?php
// Redirect to the new dynamic e-logbook system
header("Location: elogbook_dynamic.php?week=2");
exit();
?>
...
<ul id="menu_list">
  ...
  <a class="menu_items_link" href="elogbook_dynamic.php"><li class="menu_items_list" style="background-color:orange;padding-left:16px">E-Logbook</li></a>
    ...
    <div class = "panel">
      ...
      <div class="panel-body pbody">
        <div id="navigation_holder">
          <ul class = "pager">
             <li class = "previous"><a href = "elogbook_dynamic.php?week=1">&larr; Previous</a></li>
