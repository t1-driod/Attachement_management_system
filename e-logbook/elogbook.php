<?php
header("Location: elogbook_dynamic.php");
exit;
      ...
      <div class="panel-body pbody">
        <div id="navigation_holder">
          <p style="text-align: center; color: #666;">
            <em>This page has been upgraded to a dynamic system.<br>
            <a href="elogbook_dynamic.php">Click here to access the new E-LogBook system</a></em>
          </p>
        </div>
        <div id="week_holder">
