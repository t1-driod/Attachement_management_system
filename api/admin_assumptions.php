...
if ($filter && $search !== '') {
    ...
    switch ($filter) {
        ...
        case 'company_region': $where = "company_region LIKE $like"; break;
        case 'company_name': $where = "company_name LIKE $like"; break;
    }
}

$q = "SELECT index_number, first_name, last_name, programme, level, session, company_name, company_region FROM students_assumption WHERE $where ORDER BY index_number LIMIT 200";
