<?php
/**
 * GET: Serve a student's profile photo. Admin only; index_number from URL.
 * Route: /admin/student-profile/{index_number}/photo
 * $segments is set by index.php (e.g. ['admin', 'student-profile', 'INDEX', 'photo']).
 */
