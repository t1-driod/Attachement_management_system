  ...
  if($search_by!=""&& $search_term!=""){
    ...
    switch ($search_by) {
      ...
      case 'Session':
        ...
        break;
      case 'Score':
        $mysql_query_1 = "SELECT * FROM industrial_registration WHERE company_supervisor_grade LIKE '%$search_term%'";
        break;
      default:
        $mysql_query_1 = "SELECT * FROM industrial_registration";
        break;
                  ...
                  <tbody>
                    ...
                    if ($execute_result_query) {
                      while ($row_set = mysqli_fetch_array($execute_result_query)){
                        ...
                        echo "<td>".htmlspecialchars($row_set["company_supervisor_name"] ?? '')."</td>";
                        echo "<td>".htmlspecialchars($row_set["company_supervisor_contact"] ?? '')."</td>";
                        echo "<td>".htmlspecialchars($row_set["company_supervisor_grade"] ?? '')."</td>";
                        echo "</tr>";
                      }
                    }
                    ?>
